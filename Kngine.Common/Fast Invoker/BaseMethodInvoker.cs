...
namespace Kngine.Reflection.FastInvoker
{
    /// <summary>
    ...
    public static class BaseMethodInvoker
    {
        ...
        /// <param name="MethodName">Method name.</param>
        /// <returns>The Fast Invoke Handler delegate</returns>
        public static FastInvokeHandler GetMethodInvoker(Type TargetType, string MethodName, BindingFlags flags)
        {
        ...
        /// <param name="MethodName">Method name.</param>
        /// <returns>The Fast Invoke Handler delegate</returns>
        public static FastInvokeHandler GetMethodInvokerForPublicStatic(Type TargetType, string MethodName)
        {
