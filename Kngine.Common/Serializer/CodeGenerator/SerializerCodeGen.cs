...
namespace Kngine.Serializer
{
    static class SerializtionCodeGen
    {
        ...
        {
            // arg0: Stream, arg1: value, arg2: seralization
        ...
        public static void GenSerializerBody(CodeGenContext ctx, Type type, ILGenerator il)
        {
        ...
        public static void GenSerializerBodyForArray(CodeGenContext ctx, Type type, ILGenerator il)
        {
        ...
        public static void GenerateSerializerSwitch(CodeGenContext ctx, ILGenerator il, IDictionary<Type, TypeData> map)
        {
            ...
            // arg0: Stream, arg1: object, arg2: object/seralizer

            var idLocal = il.DeclareLocal(typeof(ushort));

            // get TypeID from object's Type
            var getTypeIDMethod = typeof(Serializer).GetMethod("GetTypeID", BindingFlags.Public | BindingFlags.Static | BindingFlags.ExactBinding, null, new Type[] { typeof(object), typeof(Serializer) }, null);
            il.Emit(OpCodes.Ldarg_1);
            il.Emit(OpCodes.Ldarg_2);
