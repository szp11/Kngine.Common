...
namespace Kngine.IO.Compression
{
	...
	public sealed class AcedDeflator
	{
        ...
        public unsafe byte[] Compress(byte[] sourceBytes, AcedCompressionLevel compressionLevel)
        {
            return Compress(sourceBytes, 0, sourceBytes.Length, compressionLevel, 0, 0);
        }
